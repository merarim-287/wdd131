const temples = [
  ...
  },
  {
    ...
    area: 11937, 
    imageUrl: "https://churchofjesuschristtemples.org/anchorage-alaska-temple/photographs/" 
  },
  {
    ...
    area: 20630,
    imageUrl: "https://churchofjesuschristtemples.org/manhattan-new-york-temple/photographs/" 
  },
  {
    ...
    area: 10700,
    imageUrl: "https://churchofjesuschristtemples.org/oaxaca-mexico-temple/photographs/" 
  }
];

document.getElementById("old-btn").addEventListener("click", () => filterTemples("old"));
document.getElementById("new-btn").addEventListener("click", () => filterTemples("new"));
document.getElementById("large-btn").addEventListener("click", () => filterTemples("large"));
document.getElementById("small-btn").addEventListener("click", () => filterTemples("small"));
